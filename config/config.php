<?php
// From https://gitlab.com/davical-project/davical/-/blob/e8b43e60dbbd7bf6860b00a820556ef484aca9e5/config/example-config.php
...
* $c->pg_connect.
*/
$c->pg_connect[] = "dbname=" . getenv("PGDATABASE")
                 . " user=" . getenv("PGUSER")
                 . " host=" . getenv("PGHOST")
                 . " port=" . getenv("PGPORT")
...
*/
$c->admin_email = getenv('ADMIN_EMAIL');
